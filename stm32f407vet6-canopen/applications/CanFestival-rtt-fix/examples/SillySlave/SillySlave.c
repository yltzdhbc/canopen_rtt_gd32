...
UNS32 CHANEL1 = 0x11111111;		/* Mapped at index 0x2002, subindex 0x00 */
UNS32 CHANEL2 = 0x22222222;		/* Mapped at index 0x2003, subindex 0x00 */
UNS32 CHANEL3 = 0x33333333;		/* Mapped at index 0x2004, subindex 0x00 */
UNS32 CHANEL4 = 0x44444444;		/* Mapped at index 0x2005, subindex 0x00 */
UNS32 DAY = 0x1;		/* Mapped at index 0x2006, subindex 0x00 */
UNS32 MS = 0x2;		/* Mapped at index 0x2007, subindex 0x00 */
...
/* index 0x1801 :   Transmit PDO 2 Parameter. */
                    UNS8 SillySlave_highestSubIndex_obj1801 = 6; /* number of subindex - 1*/
                    UNS32 SillySlave_obj1801_COB_ID_used_by_PDO = 0x280;	/* 640 */
                    UNS8 SillySlave_obj1801_Transmission_Type = 0x0;	/* 0 */
                    UNS16 SillySlave_obj1801_Inhibit_Time = 0x0;	/* 0 */
                    UNS8 SillySlave_obj1801_Compatibility_Entry = 0x0;	/* 0 */
                    UNS16 SillySlave_obj1801_Event_Timer = 0x0;	/* 0 */
                    UNS8 SillySlave_obj1801_SYNC_start_value = 0x0;	/* 0 */
                    ODCallback_t SillySlave_Index1801_callbacks[] = 
                     {
                       NULL,
                       NULL,
                       NULL,
                    ...
                    subindex SillySlave_Index1801[] = 
                     {
                       { RO, uint8, sizeof (UNS8), (void*)&SillySlave_highestSubIndex_obj1801 },
                       { RW, uint32, sizeof (UNS32), (void*)&SillySlave_obj1801_COB_ID_used_by_PDO },
                       { RW, uint8, sizeof (UNS8), (void*)&SillySlave_obj1801_Transmission_Type },
                       { RW, uint16, sizeof (UNS16), (void*)&SillySlave_obj1801_Inhibit_Time },
                       { RW, uint8, sizeof (UNS8), (void*)&SillySlave_obj1801_Compatibility_Entry },
                       { RW, uint16, sizeof (UNS16), (void*)&SillySlave_obj1801_Event_Timer },
                       { RW, uint8, sizeof (UNS8), (void*)&SillySlave_obj1801_SYNC_start_value }
                     };

/* index 0x1A00 :   Transmit PDO 1 Mapping. */
                    UNS8 SillySlave_highestSubIndex_obj1A00 = 4; /* number of subindex - 1*/
                    ...
                    subindex SillySlave_Index1A00[] = 
                     {
                       ...
                       { RW, uint32, sizeof (UNS32), (void*)&SillySlave_obj1A00[1] },
                       { RW, uint32, sizeof (UNS32), (void*)&SillySlave_obj1A00[2] },
                       { RW, uint32, sizeof (UNS32), (void*)&SillySlave_obj1A00[3] }
                     };

/* index 0x1A01 :   Transmit PDO 2 Mapping. */
                    UNS8 SillySlave_highestSubIndex_obj1A01 = 0; /* number of subindex - 1*/
                    UNS32 SillySlave_obj1A01[] = 
                    {
                    };
                    subindex SillySlave_Index1A01[] = 
                     {
                       { RW, uint8, sizeof (UNS8), (void*)&SillySlave_highestSubIndex_obj1A01 }
                     };
...
/* index 0x2002 :   Mapped variable CHANEL1 */
                    subindex SillySlave_Index2002[] = 
                     {
                       { RW, uint32, sizeof (UNS32), (void*)&CHANEL1 }
                     };

/* index 0x2003 :   Mapped variable CHANEL2 */
                    subindex SillySlave_Index2003[] = 
                     {
                       { RW, uint32, sizeof (UNS32), (void*)&CHANEL2 }
                     };

/* index 0x2004 :   Mapped variable CHANEL3 */
                    subindex SillySlave_Index2004[] = 
                     {
                       { RW, uint32, sizeof (UNS32), (void*)&CHANEL3 }
                     };

/* index 0x2005 :   Mapped variable CHANEL4 */
                    subindex SillySlave_Index2005[] = 
                     {
                       { RW, uint32, sizeof (UNS32), (void*)&CHANEL4 }
                     };

/* index 0x2006 :   Mapped variable DAY */
                    subindex SillySlave_Index2006[] = 
                     {
                       { RW, uint32, sizeof (UNS32), (void*)&DAY }
                     };

/* index 0x2007 :   Mapped variable MS */
                    subindex SillySlave_Index2007[] = 
                     {
                       { RW, uint32, sizeof (UNS32), (void*)&MS }
                     };
...
const indextable SillySlave_objdict[] = 
{
  ...
  { (subindex*)SillySlave_Index1801,sizeof(SillySlave_Index1801)/sizeof(SillySlave_Index1801[0]), 0x1801},
  { (subindex*)SillySlave_Index1A00,sizeof(SillySlave_Index1A00)/sizeof(SillySlave_Index1A00[0]), 0x1A00},
  { (subindex*)SillySlave_Index1A01,sizeof(SillySlave_Index1A01)/sizeof(SillySlave_Index1A01[0]), 0x1A01},
  ...
  { (subindex*)SillySlave_Index2003,sizeof(SillySlave_Index2003)/sizeof(SillySlave_Index2003[0]), 0x2003},
  { (subindex*)SillySlave_Index2004,sizeof(SillySlave_Index2004)/sizeof(SillySlave_Index2004[0]), 0x2004},
  { (subindex*)SillySlave_Index2005,sizeof(SillySlave_Index2005)/sizeof(SillySlave_Index2005[0]), 0x2005},
  { (subindex*)SillySlave_Index2006,sizeof(SillySlave_Index2006)/sizeof(SillySlave_Index2006[0]), 0x2006},
  { (subindex*)SillySlave_Index2007,sizeof(SillySlave_Index2007)/sizeof(SillySlave_Index2007[0]), 0x2007},
};
...
const indextable * SillySlave_scanIndexOD (UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x1801: i = 8;*callbacks = SillySlave_Index1801_callbacks; break;
		case 0x1A00: i = 9;break;
		case 0x1A01: i = 10;break;
 ...
 */
s_PDO_status SillySlave_PDO_status[2] = {s_PDO_status_Initializer,s_PDO_status_Initializer};
